...
class TSummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (weeks.isNotEmpty && weeks[0].gameDay.day != 1) {
      weeks = weeks.sublist(1);
    }
                  ...
                  children: [
                    ...
                    TableCell(
                      child: Container(
                        ...
                        child: const Center(
                            child:
                                Text("MAIN TEAM", textAlign: TextAlign.center)),
                      ),
                    ),
                    TableCell(
                      child: Container(
                        ...
                        child: const Center(
                            child:
                                Text("JUNIORS", textAlign: TextAlign.center)),
                      ),
                    ),
                  ],
                ),
                      ...
                      child: Container(
                        ...
                        child: const Row(
                          ...
                          children: [
                            ...
                            Expanded(child: Center(child: Text("Skills Up"))),
                          ],
                        ),
                      ),
                    ),
                    TableCell(
                      child: Container(
                        ...
                        child: const Row(
                          ...
                          children: [
                            Expanded(child: Center(child: Text("No."))),
                            Expanded(child: Center(child: Text("Levels Up"))),
                          ],
                        ),
                      ),
                    ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                                child: Center(
                                    child:
                                        Text(week.stats.advanced.toString()))),
                            Expanded(
                                child: Center(
                                    child:
                                        Text(week.stats.skillsUp.toString()))),
                          ],
                        ),
                      ),
                      TableCell(
                        child: Row(
                          ...
                          children: [
                            Expanded(
                                child: Center(
                                    child:
                                        Text(week.juniors.number.toString()))),
                            Expanded(
                                child: Center(
                                    child: Text(
